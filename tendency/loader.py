...
class Sports(Dataset):
    def __init__(self, mode, args):
        ...
        self.args = args
        if mode == 'train':
            self.seq_list, self.target, self.seq_list_sliceid, self.target_sliceid, self.user_list = load_data(f'{args.data_dir}/Sports_6/train_seq.txt')
        if mode == 'val':
            self.seq_list, self.target, self.seq_list_sliceid, self.user_list = load_data_inf(f'{args.data_dir}/Sports_6/out_val.txt')
        if mode == 'test':
            self.seq_list, self.target, self.seq_list_sliceid, self.user_list = load_data_inf(f'{args.data_dir}/Sports_6/out_test.txt')
...
class Phones(Dataset):
    def __init__(self, mode, args):
        ...
        self.args = args
        if mode == 'train':
            self.seq_list, self.target, self.seq_list_sliceid, self.target_sliceid, self.user_list = load_data(f'{args.data_dir}/Phones_6/train_seq.txt')
        if mode == 'val':
            self.seq_list, self.target, self.seq_list_sliceid, self.user_list = load_data_inf(f'{args.data_dir}/Phones_6/out_val.txt')
        if mode == 'test':
            self.seq_list, self.target, self.seq_list_sliceid, self.user_list = load_data_inf(f'{args.data_dir}/Phones_6/out_test.txt')
...
class Yelp(Dataset):
    def __init__(self, mode, args):
        ...
        self.args = args
        if mode == 'train':
            self.seq_list, self.target, self.seq_list_sliceid, self.target_sliceid, self.user_list = load_data(f'{args.data_dir}/Yelp_6/train_seq.txt')
        if mode == 'val':
            self.seq_list, self.target, self.seq_list_sliceid, self.user_list = load_data_inf(f'{args.data_dir}/Yelp_6/out_val.txt')
        if mode == 'test':
            self.seq_list, self.target, self.seq_list_sliceid, self.user_list = load_data_inf(f'{args.data_dir}/Yelp_6/out_test.txt')
