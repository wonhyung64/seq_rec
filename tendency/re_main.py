...
parser.add_argument('--dataset', default="Yelp_6", type=str)
parser.add_argument('--epoch', default=5000, type=int)
parser.add_argument('--bs', default=1024, type=int)
parser.add_argument('--bs-eval', default=256, type=int)
...
os.makedirs(f'{args.data_dir}/{args.dataset}/results', exist_ok=True)
logging.basicConfig(filename=f"{args.data_dir}/{args.dataset}/results/{args.mark}.log")
logging.info(args)
...
#%%
train_file = f'{args.data_dir}/{args.dataset}/train_seq.txt'
user_item_dict = get_user_history_eval(f'{args.data_dir}/{args.dataset}/out_val.txt',
                                        f'{args.data_dir}/{args.dataset}/out_test.txt')
